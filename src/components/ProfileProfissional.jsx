    ...
    return (  
        <>
            <div className={styles.avatarContainer}>
                ...
                <div className={styles.avatarContent} onClick={() => props.setShowAvatarList(!showAvatarList)}>
                    <p>Profissional</p>
                </div>
            </div>
            <div className={styles.inputFieldContainer}>
                ...
                <div className={styles.buttons}>
                    ...
                    <button onClick={()=>props.handleUpdate(3,{login:email,nome,nascimento,idAvatar})}>Atualizar informações</button>
                </div>
            </div>
        </>
    )
